...
export function SignalAutocomplete({
  ...
  const [searchTextEntered, setSearchTextEntered] = useState<boolean>(false);
  ...
  return (
    <Select<string, CustomOptionType>
      ...
      notFoundContent={
        isLoading ? (
          <Spin size='small' />
        ) : autocompleteSuggestions.length === 0 && searchTextEntered ? (
          <p>No suggestions found</p>
        ) : (
          <p>Please enter text to suggest relevant news articles</p>
        )
      }
